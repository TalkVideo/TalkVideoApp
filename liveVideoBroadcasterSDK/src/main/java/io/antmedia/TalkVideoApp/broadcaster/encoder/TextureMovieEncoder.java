...
import io.antmedia.TalkVideoApp.broadcaster.encoder.gles.EglCore;
...
import io.antmedia.TalkVideoApp.broadcaster.encoder.gles.WindowSurface;
...
public class TextureMovieEncoder implements Runnable {
        ...
        if (mVideoEncoder != null && (frameTime - mLastFrameTime) >= getFrameInterval())
        {
           Log.d(TAG, " get frame interval :" + getFrameInterval());
            ...
            try {
                ...
                Log.e(TAG, "Failure: transform Object Was Null Here...");
                e.printStackTrace();
            }
    ...
    public void setTextureId(int id) {
        ...
        try {
            ...
            // mHandler.sendMessage(mHandler.obtainMessage(MSG_SET_TEXTURE_ID, id, 0));
