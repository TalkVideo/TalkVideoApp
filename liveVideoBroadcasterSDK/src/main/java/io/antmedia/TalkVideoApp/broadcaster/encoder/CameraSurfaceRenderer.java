package io.antmedia.TalkVideoApp.broadcaster.encoder;
...
import io.antmedia.TalkVideoApp.broadcaster.CameraHandler;
import io.antmedia.TalkVideoApp.broadcaster.encoder.gles.FullFrameRect;
import io.antmedia.TalkVideoApp.broadcaster.encoder.gles.Texture2dProgram;
...
public class CameraSurfaceRenderer implements GLSurfaceView.Renderer {
    ...
    public void setCameraPreviewSize(int width, int height) {
        Log.i(TAG, "setCameraPreviewSize:" + " height: " + height + " width: " + width);
        mIncomingWidth = width;
        mIncomingHeight = height;
        mIncomingSizeUpdated = true;

        if (mIncomingHeight >= 1080)
        {
            bitrate = 3000000;
        }
        else if (mIncomingHeight >= 720)
        {
            bitrate = 1500000;
        }
    ...
    */
    private void drawBox() {
        ...
        GLES20.glScissor(300, 400, 300, 300);
        GLES20.glClearColor(1.0f, 0.0f, 0.0f, .0f); // No Alpha?
